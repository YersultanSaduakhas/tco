...
const Widget = (props: TimelineProps) => {
  ...
  const updateStepLength = (stepLength_: any, startIme: any) => {
          ...
          dataSources === null
            ...
            : timeSettingsForRuntime && width && <TimeLine
              ...
              onTimeChanged={(sTime, eTime) => {
                ...
                let sendData = {
                  startDate: sTime ? new Date(sTime).toLocaleString('ru-RU') : '',
                  endDate: eTime ? new Date(eTime).toLocaleString('ru-RU') : ''
                };
