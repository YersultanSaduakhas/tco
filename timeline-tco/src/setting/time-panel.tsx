    ...
    return (
      <div className='time-panel w-100 h-100' css={getStyleForTimePanel(theme)}>
        ...
        >
          ...
          {
            showStartOffset && <SettingRow label={i18nMessage('offset')} aria-label={i18nMessage('offset')}>
              <DateUnitInput
                style={{ width: '125px' }}
                step={1}
        ...
        >
          ...
          {
            showEndOffset && <SettingRow label={i18nMessage('offset')} aria-label={i18nMessage('offset')}>
              <DateUnitInput
                style={{ width: '125px' }}
                step={1}
